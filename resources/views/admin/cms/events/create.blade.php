...
@section('title', 'New Event — ICC SMS')
...
@section('content')
    <div class="max-w-xl">
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('admin.cms.events.store') }}" class="space-y-5">
                @csrf
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-navy mb-1.5">End Date & Time <span class="text-gray-400 font-normal">(optional)</span></label>
                ...
                <div>
                    <label class="block text-sm font-medium text-navy mb-1.5">Location <span class="text-gray-400 font-normal">(optional)</span></label>
                ...
                <div>
                    <label class="block text-sm font-medium text-navy mb-1.5">Description <span class="text-gray-400 font-normal">(optional)</span></label>
                    <textarea name="description" rows="4"
                              class="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-light-gray text-navy text-sm
                                     focus:outline-none focus:ring-2 focus:ring-royal focus:border-transparent">{{ old('description') }}</textarea>
                </div>
