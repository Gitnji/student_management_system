...
@section('title', 'New Teacher — ICC SMS')
@section('header', 'New Teacher')
    ...
    <div class="max-w-xl">
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('admin.teachers.store') }}" class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-navy mb-1.5">Email Address</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-navy mb-1.5">Initial Password</label>
                    ...
                    @error('password')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-gray-400 text-xs mt-1">Teacher will be forced to change this on first login.</p>
                </div>
